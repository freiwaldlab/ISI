...
if strcmp(P.altazimuth,'none')
    ...
    % Assumes a projection of spherical coordinates onto flat screen
...
%%%%%%BETA VERSION
[sdom, tdom, x_ecc, y_ecc] = makeGraterDomain_beta(xN, yN, P.ori, ...
...
if P.plaid_bit
    ...
    %end
    AZ2 = P.altazimuth;
    [sdom2, tdom2, x_ecc2, y_ecc2] = makeGraterDomain(xN, yN, P.ori2, ...
