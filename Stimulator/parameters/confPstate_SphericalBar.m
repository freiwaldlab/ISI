...
Pstate.param{2} = {'stim_time '  'float'     30       0  'sec'};
Pstate.param{3} = {'postdelay'      'float'     10       0  'sec'};

Pstate.param{4} = {'BarThickness'   'int'       5        0 'degree'};
Pstate.param{5} = {'BarOrient'      'int'       1        0  'h=1, v=0'}; %1 = horizontal, 0 = vertical
...
Pstate.param{12} = {'eyeXLocation' 'int'        26.035   0  'cm'}; %location of the eye on the x screen location
Pstate.param{13} = {'eyeYLocation' 'int'        14.605   0  'cm'}; %location of the eye on the y screen location 
